    ...
    <div className="relative h-[400px] md:h-[500] lg:h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center z-10">
        <div className="text-center px-5 lg:w-2/3">
          <h5 className="text-orange">Electronic Repair</h5>
          <h1 className="text-[#fff] text-2xl lg:text-6xl font-bold my-3 md:my-6">
            Rebuilt Your Old Electronic & Get The New Experience
          </h1>
          <p className="text-[#fff] text-xs md:text-lg lg:leading-7 font-light mb-6">
